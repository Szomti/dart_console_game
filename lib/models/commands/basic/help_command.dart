...
class HelpCommand extends Command {
  ...
  static final Iterable<HelpInfo> commands =
      Command.fullList.map((e) => e.helpInfo);
  ...
  void execute() {
    final filtered = argsString().isNotEmpty
        ? commands.where((element) => element.containsAnywhere(argsString()))
        : commands;
    final sortedList = filtered.sorted((a, b) {
